...
<link href="${pageContext.request.contextPath}/assets/css/book/reg_book_side_list.css" rel="stylesheet" type="text/css" />

<!-- 등록된 도서 card -->
<div class="btnGroup commonWidth" style="float:left;">
	<button class="btn btn-secondary" style="float:left;" onclick="checkAll()">전체선택</button>
	<button class="btn btn-secondary" style="float:left; margin-left:5px;" onclick="uncheckAll()">전체해제</button>
	<button class="btn btn-secondary" style="float:left; margin-left:5px;" onclick="clickedPrintChkList()">인쇄</button>
	<button class="btn btn-secondary" style="float:right;" onclick="clickedDeleteBatchBook()">
		삭제
	</button>
</div>
<div class="card-body commonWidth side__list__body" style="float:left; max-width:800px; height:800px; overflow-y:auto;">
		...
		<table class="table table-sm table-bordered">
			<thead>
				<tr>
					...
					<th class="table-secondary text-center" style="width:180px; vertical-align:middle;" rowspan="2">도서명</th>
					...
					<th class="table-secondary text-center" style="width:80px; vertical-align:middle;" rowspan="2">등록번호</th>
