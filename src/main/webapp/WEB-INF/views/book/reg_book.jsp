...
<%@ include file="/WEB-INF/inc/head.jsp"%>
	...
	<link href="${pageContext.request.contextPath}/assets/css/book/reg_book.css" rel="stylesheet" type="text/css" />
</head>
<body>
							...
							<div class="makeAtc">
								<div class="form-inline mb-1">
									<div class="form-group col-12">
										<label for='bookTitle' class="col-2 control-label">도서명</label>
										<div class="col-10">
								...
								<div class="form-inline mb-1">
									<div class="form-group col-12">
										<label for='author' class="col-2 control-label">저자명</label>
										<div class="col-4">
											<input type="text" name="author" id="author"
												class="form-control form-control-sm input-clear" />
										</div>

										<label for='authorCode' class="col-2 control-label">저자기호</label>
										<div class="col-4">
								...
								<div class="form-inline mb-1">
									<div class="form-group col-12">
										...
										<label for='checkBoxAddiCode' class="col-2 control-label">
											별치기호
											<input type="checkbox" id="checkBoxAddiCode" class="checkbox__addi__code"/>
										</label>
										<div class="col-4 div__addi__select__or__input">
											<c:choose>
												<c:when test="${fn:length(addiCodeList) gt 0}">
													<select name="additionalCode" id="additionalCode"
														class="form-control form-control-sm select__input">
								...
								<div class="form-inline mb-1">
									<div class="form-group col-12">
										<label for='volumeCode' class="col-2 control-label">
											권차기호</label>
										<div class="col-4">
										...
										<label for='copyCode' class="col-2 control-label">
											복본기호</label>
										<div class="col-4">
											<!-- <span style="">C</span> -->
								...
								<div class="form-inline mb-1">
									<div class="form-group col-12">
										<label for='publisher' class="col-2 control-label">출판사</label>
										<div class="col-4">
										...
										<label for='pubDate'
											class="col-2 col-offset-1 control-label">출판일</label>
										<div class="col-4">
								...
								<div class="form-inline mb-1">
									<div class="form-group col-12">
										<label for='bookOrNot' class="col-2 control-label"
											style="font-size:13px;">
											도서/비도서
										</label>
										<div class="col-4">
											<select name="bookOrNot" class="form-control form-control-sm select__input">
										...
										<label for='purOrDon' class="col-2 control-label">수입구분</label>
										<div class="col-4">
								...
								<div class="form-inline mb-1">
									<div class="form-group col-12">
										...
										<div class="col-2">
											<label for='checkBoxBookShelf' class="control-label">
												서가
												<input type="checkbox" id="checkBoxBookShelf" class="checkbox__book_shelf"/>
											</label>
										</div>
										<div class="col-4 div__bookshelf__select__or__input">
											<c:choose>
												<c:when test="${fn:length(bookShelfList) gt 0}">
													<select name="bookShelf" id="bookShelf"
														class="form-control form-control-sm select__input">
														<option value="" selected>-선택-</option>
														<c:forEach var="bookShelfItem" items="${bookShelfList}" varStatus="status">
															<c:choose>
																<c:when test="${bookShelfItem eq null}">
																</c:when>
																<c:otherwise>
																	<option value="${bookShelfItem}">${bookShelfItem}</option>
																</c:otherwise>
															</c:choose>
														</c:forEach>
													</select>
								...
								<div class="form-inline mb-1">
									<div class="form-group col-12">
										...
										<label for='newBarcode' class="col-2 control-label label__barcode">
											도서등록번호</label>
										<div class="col-4">
								...
								<div class='form-horizontal'>
									<div class="form-group col-11" style="margin:auto; margin-bottom:14px;">
										...
										<div class="form-inline">
											<div class="form-control form-control-sm col-md-2 input-clear img__div"
