...
<body>
	<form class="" name="tag-color-setting-form" method="post"
		...
		<div style="float:left; margin-left:50px; width:400px;">
			<table class="table table-bordered clickCls">
				<thead>
					<tr>
						<td>현재</td>
						<td>변경</td>
