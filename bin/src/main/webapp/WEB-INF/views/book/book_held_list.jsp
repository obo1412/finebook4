							...
							<div class="float-left mr-2">
								...
								<div class="input-group mt-1">
									<span class="input-group-prepend">
										<select class="form-control" id="a4LabelType">
									...
									<input class="form-control text-center input-group-prepend" type="text" id="startPoint" style="width:100px;"
										placeholder="인쇄위치"/>
